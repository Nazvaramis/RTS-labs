...
public class Supervisor_Transistion_ts2 implements TransitionTemplate {
    ...
    public Supervisor_Transistion_ts2( String name, PlaceHandlerTemplate PH,Integer delay) {
        this.Init(name, PH);
        this.SetDelay(delay);
    }

    public Supervisor_Transistion_ts2( String name, PlaceHandlerTemplate PH,Integer eet, Integer let) {
        this.Init(name, PH);
    ...
    public Boolean TransitionGuardsMappings() {
        ...
        List<relations> list= (List<relations>) PH.GetPlaceByName("ps_1").Get();
        Integer r = null;
        try {
