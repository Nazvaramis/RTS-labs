...
public class Supervisor_Transistion_ts1 implements TransitionTemplate {
    ...
    public Supervisor_Transistion_ts1(String name, PlaceHandlerTemplate PH,Integer delay) {
        this.Init(name, PH);
        this.SetDelay(delay);
    }

    public Supervisor_Transistion_ts1(String name, PlaceHandlerTemplate PH, Integer eet, Integer let) {
        this.Init(name, PH);
    ...
    public Boolean TransitionGuardsMappings() {
        ...
        if (!PH.GetPlaceByName("ps_i1").IsNull() ) {
            ...
            list= (List<relations>) PH.GetPlaceByName("ps_1").Get();

            list.add((relations) PH.GetPlaceByName("ps_i1").Get());
